...
Route::middleware('auth')->group(function () {
    ...
    Route::get('settings/billing', [SettingsController::class, 'index'])->name('admin.billing-settings.edit');
    Route::post('settings/billing', [SettingsController::class, 'update'])->name('admin.billing-settings.update');
