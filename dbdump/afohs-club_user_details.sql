...
CREATE TABLE `user_details` (
  ...
  `coa_account` varchar(255) DEFAULT NULL,
  `title` varchar(255) DEFAULT NULL,
  `state` varchar(255) DEFAULT NULL,
  `application_number` varchar(255) DEFAULT NULL,
  `name_comments` text DEFAULT NULL,
  `guardian_name` varchar(255) DEFAULT NULL,
  `guardian_membership` varchar(255) DEFAULT NULL,
  ...
  `membership_reason` text DEFAULT NULL,
  `mobile_number_a` varchar(255) DEFAULT NULL,
  `mobile_number_b` varchar(255) DEFAULT NULL,
  `mobile_number_c` varchar(255) DEFAULT NULL,
  `telephone_number` varchar(255) DEFAULT NULL,
  `personal_email` varchar(255) DEFAULT NULL,
  `critical_email` varchar(255) DEFAULT NULL,
