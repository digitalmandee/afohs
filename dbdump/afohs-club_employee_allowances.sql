...
CREATE TABLE `employee_allowances` (
  ...
  KEY `employee_allowances_allowance_type_id_index` (`allowance_type_id`),
  KEY `employee_allowances_effective_from_effective_to_index` (`effective_from`,`effective_to`),
  CONSTRAINT `employee_allowances_allowance_type_id_foreign` FOREIGN KEY (`allowance_type_id`) REFERENCES `allowance_types` (`id`) ON DELETE CASCADE,
