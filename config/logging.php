    ...
    */
    ...
    'channels' => [
        ...
        'accounting' => [
            ...
            'level' => env('LOG_ACCOUNTING_LEVEL', 'debug'),
            'days' => env('LOG_ACCOUNTING_DAYS', 30),
            'replace_placeholders' => true,
        ],
        ...
        'procurement' => [
            ...
            'level' => env('LOG_PROCUREMENT_LEVEL', 'debug'),
            'days' => env('LOG_PROCUREMENT_DAYS', 30),
            'replace_placeholders' => true,
        ],
        ...
        'printing' => [
            ...
            'level' => env('LOG_PRINTING_LEVEL', 'debug'),
            'days' => env('LOG_PRINTING_DAYS', 30),
            'replace_placeholders' => true,
        ],
