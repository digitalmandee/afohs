            ...
            children: [
                {
                    ...
                    children: [
                        ...
                        { text: 'Accounting Vouchers', path: route('accounting.vouchers.index'), permission: 'financial.view' },
                        { text: 'Voucher Mappings', path: route('accounting.vouchers.mappings.index'), permission: 'financial.view' },
                ...
                },
                {
                    text: 'Reports',
                    children: [
                        { text: 'Report Hub', path: route('accounting.reports.hub'), permission: 'financial.view' },
                    ],
                },
            ],
        },
