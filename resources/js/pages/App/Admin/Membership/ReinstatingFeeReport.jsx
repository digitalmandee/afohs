...
const ReinstatingFeeReport = () => {
    ...
    const handleSearch = () => {
        router.get(route('membership.reinstating-fee-report'), allFilters, {
            preserveState: true,
            preserveScroll: true,
        });
    };
            ...
            <div className="container-fluid px-4 py-4" style={{ backgroundColor: '#f5f5f5', minHeight: '100vh', overflowX: 'hidden' }}>
                ...
                <div className="d-flex justify-content-between align-items-center mb-4">
                    <div className="d-flex align-items-center">
                        ...
                        <Typography sx={{ fontWeight: 600, fontSize: '24px', color: '#063455' }}>Reinstating Fee Report</Typography>
                    </div>
                    <Button
                        variant="contained"
                        startIcon={<Print />}
...
export default ReinstatingFeeReport;
