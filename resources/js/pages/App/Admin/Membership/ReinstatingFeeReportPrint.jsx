...
export default function ReinstatingFeeReportPrint({ transactions, statistics, filters, all_categories, all_cashiers }) {
    useEffect(() => {
    ...
    const getFilterText = () => {
        ...
        if (filters.cashier) {
            ...
            if (cashier) {
                filterText.push(`Cashier: ${cashier.name}`);
            }
        }
    ...
    return (
        <>
            <Head title="Reinstating Fee Report - Print" />
            ...
            <Box sx={{ maxWidth: '100%', mx: 'auto', bgcolor: 'white', p: 3 }}>
                ...
                <div className="report-header">
                    ...
                    <div className="report-subtitle">Reinstating Fee Report</div>
