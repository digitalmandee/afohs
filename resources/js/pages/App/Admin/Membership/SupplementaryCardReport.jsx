    ...
    return (
        <>
            ...
            <div className="container-fluid px-4 py-4" style={{ backgroundColor: '#f5f5f5', minHeight: '100vh', overflowX: 'hidden' }}>
                ...
                <div className="d-flex justify-content-between align-items-center mb-4">
                    <div className="d-flex align-items-center">
                        ...
                        <Typography sx={{ fontWeight: 600, fontSize: '24px', color: '#063455' }}>
                            Supplementary Card Detail Report
                        </Typography>
                    </div>
                    <Button
                        variant="contained"
                ...
                <Box sx={{ mb: 3, pt: 2 }}>
                    ...
                    <Grid container spacing={3} alignItems="center">
                        <Grid item xs={12} md={3}>
                            ...
                            <Autocomplete
                                multiple
                                value={safeAllCategories.filter(cat => allFilters.categories?.includes(cat.id)) || []}
                ...
                {/* Supplementary Card Statistics Table */}
                <Box sx={{ mb: 3 }}>
...
export default SupplementaryCardReport;
