...
const CancelledReport = ({ bookings = {}, filters = {} }) => {
    ...
    const handlePrint = () => {
        ...
        const printUrl = route('rooms.reports.cancelled.print', Object.fromEntries(params));
        window.open(printUrl, '_blank');
    };

    const handleExport = () => {
        const params = new URLSearchParams(window.location.search);
        const exportUrl = route('rooms.reports.cancelled.export', Object.fromEntries(params));
